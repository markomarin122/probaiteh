...
const ReservationEditModal = ({ reservation, onClose, onSave }) => {
    ...
    const fetchUnavailableDates = async (vehicleId) => {
        try {
            const res = await axios.get(`http://localhost:8000/api/vehicles/${vehicleId}/unavailable-dates`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8000/api/reservations/${reservation.id}`,
                formData,
